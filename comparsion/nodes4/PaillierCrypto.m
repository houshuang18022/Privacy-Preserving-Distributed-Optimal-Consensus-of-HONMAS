classdef PaillierCrypto < handle
    ...
    properties
        PublicKey
        BitLength = 128 % default bit lenght
    end
    ...
    methods (Access = public)
        ...
        function keys = generateKeys(obj, varargin)
            ...
            %     struct(
            %         publicKey:  struct(
            %             n:      [1? java.math.BigInteger],
            %             n2:     [1? java.math.BigInteger],
            %             g:      [1? java.math.BigInteger]
            %         )
            %         privateKey: struct(
            %             lambda: [1? java.math.BigInteger],
            %             mu:     [1? java.math.BigInteger],
            %             p:      [1? java.math.BigInteger],
            %             q:      [1? java.math.BigInteger],
            %             n:      [1? java.math.BigInteger],
            %             n2:     [1? java.math.BigInteger]
            %         )
            %    )
